...
- Finished being peer reviewed by pyOpenSci
- Improved documentation
- Adds penalization to Metamer / MAD Competition
- Improved efficiency for steerable pyramid and Portilla-Simoncelli texture model

Next steps:
<!-- .element: style="margin-top: 1%" -->
- Submit paper to JOSS
- Add "generic" synthesis object
...
- Finalize color and pooled texture models (e.g., Freeman and Simoncelli, 2011)
