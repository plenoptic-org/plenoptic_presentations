...
this is especially important because most interesting models are nonlinear, and so it's not straightforward to extrapolate how they'll behave to very different data
...
Examples of synthesis methods in the literature:
</div>

- <!-- .element: class="fragment appear" data-fragment-index="0" -->
Understanding human peripheral sensitivity  to summary stats [1-4]
- <!-- .element: class="fragment appear"  data-fragment-index="1" -->
Distinguish primate V1 from V2 [5]
- <!-- .element: class="fragment appear"  data-fragment-index="2" -->
Distinguish between object and summary statistics representation in human ventral stream [6]
- <!-- .element: class="fragment appear"  data-fragment-index="3" -->
Modulate responses in macaque V1, V2, V4 [7-9]
- <!-- .element: class="fragment appear"  data-fragment-index="4" -->
Compare human and deep net representations [10,11]
- <!-- .element: class="fragment appear"  data-fragment-index="5" -->
Understand cuttlefish camoflage [12,13]
- <!-- .element: class="fragment appear"  data-fragment-index="6" -->
Compare model of amblyopic perceptual distortions to human drawings [14]
- <!-- .element: class="fragment appear"  data-fragment-index="7" -->
Determine dimensionality of human color vision [15]
...
1. <!-- .element: class="fragment appear" data-fragment-index="0" --> Freeman and Simoncelli, 2011
2. <!-- .element: class="fragment appear" data-fragment-index="0" --> Wallis et al., 2016
3. <!-- .element: class="fragment appear" data-fragment-index="0" --> Ziemba and Simoncelli, 2021
4. <!-- .element: class="fragment appear" data-fragment-index="0" --> Broderick et al., 2025
5. <!-- .element: class="fragment appear" data-fragment-index="1" --> Freeman et al., 2013
6. <!-- .element: class="fragment appear" data-fragment-index="2" --> Long et al., 2018
7. <!-- .element: class="fragment appear" data-fragment-index="3" --> Ziemba et al., 2018
8. <!-- .element: class="fragment appear" data-fragment-index="3" --> Lieber et al., ongoing
9. <!-- .element: class="fragment appear" data-fragment-index="3" --> Agarwal et al., ongoing
10. <!-- .element: class="fragment appear" data-fragment-index="4" --> Berardino et al., 2017
11. <!-- .element: class="fragment appear" data-fragment-index="4" --> Feather et al., 2019
12. <!-- .element: class="fragment appear" data-fragment-index="5" --> Woo, 2024
13. <!-- .element: class="fragment appear" data-fragment-index="5" --> Shook et al., ongoing
14. <!-- .element: class="fragment appear" data-fragment-index="6" --> Olianezhad et al., 2025
15. <!-- .element: class="fragment appear" data-fragment-index="7" --> Helmholtz, 1852

<!-- .element: style="margin-top: 2em" class="three-columns-text reference" -->
</div>
